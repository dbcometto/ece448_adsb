...
class ppm_gen(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ppm_gen")
        ...
        self.digital_map_bb_0 = digital.map_bb([1,2,0])
        self.blocks_vector_source_x_0 = blocks.vector_source_b((2,2,2,2,2)*10 + (1,1,0,0), True, 1, [])
        self.blocks_unpack_k_bits_bb_0 = blocks.unpack_k_bits_bb(2)
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_float*1, (int(samp_rate*t_bit)))
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_char_to_float_0 = blocks.char_to_float(1, 1)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 2000000, 1, 0, 0)
...
def main(top_block_cls=ppm_gen, options=None):
